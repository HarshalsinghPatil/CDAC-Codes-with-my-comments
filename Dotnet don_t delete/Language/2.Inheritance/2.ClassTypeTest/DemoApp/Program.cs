...
jack.Hours = 186;
jack.Rate = 52;
Console.WriteLine("Jack's Income is {0:0.00}, Tax is {1:0.00} and Bonus is {2:0.00}", jack.Income(),
 Tax(jack), Bonus(jack));
SalesPerson jill = new SalesPerson(186, 52, 48000);
Console.WriteLine("Jill's Income is {0:0.00}, Tax is {1:0.00} and Bonus is {2:0.00}", jill.Income(),
 Tax(jill), Bonus(jill));
Console.WriteLine("Number of Employees = {0}", Employee.CountInstances());
//Bonus(null);

//local function (method defined in another method) does not support overloading
...
{//it is used for instanceof in java
