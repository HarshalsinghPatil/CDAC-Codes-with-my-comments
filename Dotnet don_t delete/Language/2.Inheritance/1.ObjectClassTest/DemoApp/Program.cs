class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        Print("Total", t);
        Console.WriteLine("---------------------------------");
        // here we are checking weather this are identical(i.e. both objectts points to the same memory location)
        ...
        Console.WriteLine("---------------------------------");
        //here we are checking are they exactly same ==> equal(i.e. checks the values inside the objects)
        ...
        //auto-boxing in conversion of value-type to reference type
